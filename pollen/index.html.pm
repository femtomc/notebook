...
◊note{This is a small personal wiki of notes and writings, ◊link["https://github.com/jethrokuan/braindump"]{inspired by Jethro Kuan's braindump}. The directed graph represents the wiki: the nodes are individual notes (or ◊i{zettel}, in ◊i{zettelkasten} style) and the directed edges are forward links from note to note.
